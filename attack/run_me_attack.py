...
class Genetic():
    ...
    def __init__(self, ori_sent, tar_img_path, tar_sent, log_save_path, intem_img_path, 
        ...
        map_grid_size = (10,)
        behavior_space = np.array([[10, 10], [100, 60]])
    ...
    def run(self, log=None):
        ...
        while itr <= self.max_iters:
            ...
            self.pop, pop_scores = self.me.random_selection(num_random=2*self.pop_size)

            next_pop = get_new_pop(self.pop, pop_scores, self.pop_size)
...
if __name__ == "__main__":
    ...
    st = time.time()
    g = Genetic(args.ori_sent, args.tar_img_path, args.tar_sent, args.log_save_path, 
                args.intem_img_path, args.elite_img_path, args.log_path, args.save_all_images)
